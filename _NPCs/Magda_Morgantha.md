...
**A witch is defined by her resonance collection** \
**Crazy sprite lady** \
**Artisan resonance crafter** \
**Ambition is a virtue**

## Skills
+5 Channel mutual information \
+4 grounding \
+4 craft (alchemy/enchanting)

## Skills/extras
Channeling Mutual Information \
The sprite for the job: Because **A witch is defined by her resonance collection** and I'm a **Crazy Sprite Lady**, Once per scene I can add an aspect representing a resonance bottle or sprite with a free invoke without spending a fate point. \
Embodied magic: Because I am an **Artisan resonance crafter**, I can use craft to make potions or magic items if I have the relevant resonance or sprites. \
Seer: Because I am a **Titan of Tea leaves and tarot** I may use channel mutual info instead of notice/lore when actively performing a reading.